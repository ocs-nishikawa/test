...
class Classroom_Table(models.Model):
    classroom_id = models.AutoField(primary_key=True  , blank=False , null=False)
...
class Co2_Table(models.Model):
    co2_id = models.AutoField(primary_key=True  , blank=False , null=False, default="Not entered")
    ...
    classroom_id = models.CharField( max_length = 40 , blank=False , null=False)
